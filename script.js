...
const API_KEY = "845929fce556ed611991487110985e81";
...
function getSearchWeatherData(searchterm) {
  fetch(
...
document
  ...
  .addEventListener("submit", function (event) {
    ...
    let searchTerm = document.getElementById("cityname").value;
    getSearchWeatherData(searchTerm);
  });
